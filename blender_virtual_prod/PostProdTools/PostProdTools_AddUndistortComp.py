...
class AddUndistortCompOp(bpy.types.Operator):
    bl_label = "Initialize Camera Hierarchy Operator"
    bl_idname = "julouj_virtual_prod.post_prod_tools_add_undistort_comp_op"
    bl_description = "Create a compositing nodegraph that undistorts the plate"
    ...
    def execute(self, context):
        ...
        cx_add_halfres.location = -1600,-600
        ...
        cy_add_halfres.location = -1600,-800
        ...
        cx_divide_res.location = -1400,-600
        ...
        cy_divide_res.location = -1400,-800
        ...
        aspect_value.inputs[0].default_value = 1080
        aspect_value.inputs[1].default_value = 2
        ...
        # link Centershift
        link_cx_x_sub_half = links.new(cx_divide_res.outputs[0], x_sub_half.inputs[1])
        link_cy_y_sub_half = links.new(cy_divide_res.outputs[0], y_sub_half.inputs[1])
        ...
        link_distXM_xAddH= links.new(distXM.outputs[0], x_add_half.inputs[0])
        ...
        link_yAspM_yAddH= links.new(y_aspect_mult.outputs[0], y_add_half.inputs[0])
...
def register():
    bpy.utils.register_class(AddUndistortCompOp)


def unregister():
    bpy.utils.unregister_class(AddUndistortCompOp)
